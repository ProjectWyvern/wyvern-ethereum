          ...
          .then(() => {
            ...
            return TestToken.deployed().then(tokenInstance => {
              return deployer.deploy(WyvernTokenTransferProxy, WyvernProxyRegistry.address).then(() => {
                ...
                return deployer.deploy(WyvernExchange, WyvernProxyRegistry.address, WyvernTokenTransferProxy.address, (network === 'development' || network === 'rinkeby') ? tokenInstance.address : '0x056017c55ae7ae32d12aef7c679df83a85ca75ff', '0x056017c55ae7ae32d12aef7c679df83a85ca75ff')
                  .then(() => {
